let categoria = localStorage.getItem('categorie');
...
const modificarHero = () => {
    document.getElementById('banner').style.backgroundImage = 'url(../img/' + categoria + '.jpg)';
    document.getElementById('banner__title').textContent= categoria.toUpperCase();
}
